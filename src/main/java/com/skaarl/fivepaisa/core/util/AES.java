package com.skaarl.fivepaisa.core.util;
...
public class AES {
	...
	public static String encrypt(String data, FivePaisaConfig config) {
		try {
	...
	public static String decrypt(String data, FivePaisaConfig config) {
		try {
			char[] passwordchars = config.getEncryptKey().toCharArray();
			SecretKeyFactory factory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA1");
			PBEKeySpec pbeKeySpec = new PBEKeySpec(passwordchars, salt, 1000, 256 + 128);
